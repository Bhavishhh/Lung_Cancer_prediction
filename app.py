...
def predict():
    ...
    if outp=="positive":
        ...
        return render_template('result.html',prediction_text='THERE IS A PROBABILITY OF LUNG CANCER')
    else:
        return render_template('result.html',prediction_text='LOW PROBABILITY OF LUNG CANCER')
